...
public interface SysRoleMapper {
    ...
    List<SysRole> getPage(@Param("pageNumKey") int pageNum, @Param("pageSizeKey") int pageSize, @Param("keyword") String keyword, @Param("departmentId") String departmentId);
    ...
    List<SysRole> selectRolesByDepartmentId(String departmentId);
