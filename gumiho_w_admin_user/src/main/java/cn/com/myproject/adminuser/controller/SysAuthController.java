...
import cn.com.myproject.adminuser.util.GridJsonResult;
import cn.com.myproject.adminuser.util.JsonResultUtil;
...
public class SysAuthController {
    ...
    public PageInfo<SysRoleVO> getList(int rows, int page,String keyword,String departmentId) {
        PageInfo<SysRoleVO> list = sysRoleService.getPage(page, rows,keyword,departmentId);
        return list;
    }
    ...
    private String menutoJson(SysResourceVO sysResourceVO, List<SysRoleResourceVO> sysRoleResourceList){
        ...
        //如果有子，继续
        if(sysResourceVO.getHasChildren()){
