...
<#--<#assign menuId="740ca3e13eaf41fa83e09c73ac4c40e8"/>-->
...
<input type="hidden" id="menuId" value="740ca3e13eaf41fa83e09c73ac4c40e8"/><#--menu active-->
    ...
    <form class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-8 col-xs-8">
                <input type="text" id="auth-keyword-1" placeholder="权限名称" class="col-xs-2 ">
                &nbsp;&nbsp;<button type="button" class="btn btn-info btn-sm" id="auth-search">查询</button>
            </div>
        </div>
    </form>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height:600px; overflow:scroll; ">
                ...
                <form id="resources-form-typeup" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="recordName">权限名称:</label>
                        <div class="col-sm-9">
                            <input type="text" id="roleNames" name="roleName" placeholder="权限名称"
            ...
            <div class="modal-body" style="max-height:600px; overflow:scroll; ">
                <form id="add-form-typeup" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="recordName">权限名称:</label>
                        <div class="col-sm-9">
                            <input type="text" id="roleName" name="roleName" placeholder="权限名称"
                                   class="col-xs-12 col-sm-5" value="" onblur="checkrole()"/>
                        </div>
                    </div>
                    <div class="hr hr-18 dotted"></div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="smaller lighter blue no-margin">权限对应资源设置</h3>
            </div>
            <div class="modal-body" style="max-height:600px; overflow:scroll; ">
...
<script src="${ctx}/js/sys/auth.js?v=0.0.3"></script>
