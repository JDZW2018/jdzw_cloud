    ...
    <div class="footer-inner">
        <div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">奈斯牛</span>
							 &copy; 2017-2020
						</span>
...
<script src="${ctx}/js/commons/checkloginname.js"></script>
<script src="${ctx}/js/commons/createMenu.js"></script>
<script src="${ctx}/js/commons/getTitleName.js"></script>